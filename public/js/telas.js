...
Telas.executarMotor = async (el) => {
  const render = async () => {
    ...
    const nomesEstado={CONCLUIDO:'Concluído',PROCESSANDO:'Em execução',AGUARDANDO:'Aguardando',FALHOU:'Falhou'};
    ...
    const ativo=job && ['PENDENTE','PROCESSANDO','AGUARDANDO','SINCRONIZANDO_CADASTRO','CALCULANDO','PUBLICANDO'].includes(String(job.estado || job.status));
