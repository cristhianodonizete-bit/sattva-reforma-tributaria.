...
async function telaPrecificacaoVersionada(el) {
  ...
  el.innerHTML=cab('Módulo 2','Precificação versionada','Cada cálculo gera uma versão auditável. A alíquota da CBS é sempre acompanhada da evidência do motor tributário.',`<button class="btn" id="novoItemPrec">Novo item</button><button class="btn vazio" id="creditosGlobaisPrec">Créditos globais</button><button class="btn vazio" id="importacoesPrec">Lotes de importação</button><button class="btn vazio" id="reprocessarTodosPrec">Reprocessar calculados</button><button class="btn vazio" id="voltarPrecVersionada">Voltar</button>`) +
