...
Telas.utilidadesFiscais = async (el) => {
  ...
  el.innerHTML = cab('CONSULTA OFICIAL', 'Utilidades fiscais', 'Legislação, tabelas técnicas e fontes oficiais verificadas diariamente. Uma alteração encontrada abre revisão; nunca muda o motor automaticamente.') +
    ...
    <section class="cartao" style="margin-top:16px"><h2>Tabelas fiscais</h2><div class="grade g2"><article><h3>LC 116 × NBS × cIndOp</h3><p class="desc">Tabela oficial do Anexo VIII do Portal Nacional da NFS-e: correlação entre LC 116, NBS, cIndOp e cClassTrib. A publicação é monitorada diariamente; não depende de planilha carregada no sistema.</p><a class="btn vazio pq" target="_blank" rel="noopener" href="https://www.gov.br/nfse/pt-br/biblioteca/documentacao-tecnica/rtc/anexoviii-correlacaoitemnbsindopcclasstrib_ibscbs_v1-00-00.xlsx/@@download/file">Abrir tabela oficial ↗</a></article><article><h3>Anexos e cClassTrib IBS/CBS</h3><p class="desc">Catálogo técnico da NF-e, incluindo cClassTrib, CST, anexos e regras carregadas. A fonte é o Portal NF-e informado.</p><a class="btn vazio pq" target="_blank" rel="noopener" href="https://www.nfe.fazenda.gov.br/portal/exibirArquivo.aspx?conteudo=D5b4Ov84WDg=">Abrir tabela oficial ↗</a></article></div><h3 style="margin-top:20px">cBenef por UF</h3><p class="desc">O Portal NF-e indica que apenas estas UFs utilizam tabela cBenef. Cada link aponta para a publicação estadual responsável; a atualização diária identifica mudanças no portal central da NF-e.</p><div class="tags" style="gap:8px">${cbenef.map(([uf,url]) => `<a class="tag" target="_blank" rel="noopener" href="${A.esc(url)}">${uf} ↗</a>`).join('')}</div></section>
