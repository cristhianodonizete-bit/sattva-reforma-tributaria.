...
const esquemas = {
  ...
  perfil_tributario: { id: 'bigint primary key', empresa_id: 'bigint', competencia: 'text', receita_bruta: 'numeric', receita_recebida: 'numeric', receita_mercadorias: 'numeric', receita_servicos: 'numeric', receita_exportacao: 'numeric', icms: 'numeric', iss: 'numeric', ipi: 'numeric', pis: 'numeric', cofins: 'numeric', das: 'numeric', creditos_tomados: 'numeric', origem: 'text', criado_em: 'text' },
  base_ncm: { id: 'bigint primary key', ncm: 'text', descricao: 'text', cst: 'text', cclasstrib: 'text', classificacao: 'text', anexo: 'text', fundamento: 'text', reducao_ibs: 'numeric', reducao_cbs: 'numeric', regra: 'text', fonte: 'text', candidatos: 'integer', reducao: 'text' },
  base_servicos: { id: 'bigint primary key', lc116: 'text', nbs: 'text', descricao_item: 'text', descricao_nbs: 'text', onerosa: 'text', exterior: 'text', indop: 'text', local_incidencia: 'text', cclasstrib: 'text', nome_cclasstrib: 'text', reducao: 'text' },
  turmas: { id: 'bigint primary key', empresa_id: 'bigint', trilha: 'text', titulo: 'text', formato: 'text', data: 'text', carga_horaria: 'numeric', instrutor: 'text', limite_participantes: 'integer', status: 'text', observacoes: 'text' },
  participantes: { id: 'bigint primary key', turma_id: 'bigint', empresa_id: 'bigint', nome: 'text', area: 'text', email: 'text', presenca: 'boolean', nota_avaliacao: 'numeric' },
};
