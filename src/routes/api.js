...
router.get('/empresas/:id/precificacao/base-operacional/template', (_req,res) => {
  ...
  aba('Base_Operacional',['codigo','descricao','modelo','fornecedor_cnpj','pis','cofins','valor_aquisicao','prazo_depreciacao_meses','valor_residual','evidencia'],['LOC-001','Equipamento locado','LOCACAO','00000000000000',0,0,120000,60,20000,'Contrato e NF de aquisição']);
  aba('Estrutura_Itens',['codigo_item','codigo_componente','descricao','tipo_componente','valor','pis','cofins','fornecedor_cnpj','evidencia'],['PROD-001','MP-001','Matéria-prima','MATERIA_PRIMA',100,1.65,7.6,'00000000000000','NF de entrada']);
