...
const CAMPOS_RECEITA_SEM_DFE = {
  ...
  identificador_origem: ['identificadororigem', 'identificadorquestor', 'idlancamento', 'numerolancamento', 'nrlcto', 'lancamento'],
  especie_questor: ['especiequestor', 'especie', 'especiedocumento'],
  segregacao_apuracao: ['segregacaoapuracao', 'segregacao', 'blocopgdas', 'naturezaapuracao'],
  base_pis_cofins_atual: ['basepiscofinsatual', 'basepiscofins', 'basetributavelpiscofins'],
  pis_atual: ['pisatual', 'pisdolancamento', 'valorpisatual'], cofins_atual: ['cofinsatual', 'cofinsdolancamento', 'valorcofinsatual'],
  criterio_tributacao_atual: ['criteriotributacaoatual', 'criteriodetributacaoatual', 'criteriorateio', 'criteriopiscofins'], tributacao_atual_origem: ['tributacaoatualorigem', 'origemtributacaoatual', 'origemdatributacaoatual', 'fontepiscofins'], origem: ['origem', 'sistemaorigem'],
};
