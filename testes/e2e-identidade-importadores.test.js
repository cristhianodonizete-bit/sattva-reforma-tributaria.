...
const db=require('../src/db');const periodo=require('../src/services/periodoAnalisado');require('../src/services/operacaoCompartilhada').publicar=async()=>({teste:true});
...
async function main(){
 ...
 periodo.salvar(a,{competencia_inicio:'2026-01',competencia_fim:'2026-12'},'teste');
 periodo.salvar(b,{competencia_inicio:'2026-01',competencia_fim:'2026-12'},'teste');
