...
const db=require('../src/db'),cfc=require('../src/services/cadastroFiscalComplementar'),sombra=require('../src/services/motorCondicionalPisCofins');
const e=db.prepare("insert into empresas(cnpj,razao_social) values('33333333000133','E2E sombra')").run().lastInsertRowid;
const p=Number(db.prepare('INSERT INTO produtos_empresa (empresa_id,codigo_produto_atual,ncm_atual,descricao_atual) VALUES (?,?,?,?)').run(Number(e),'TESTE','99999999','Teste').lastInsertRowid);
