...
db.exec(`
  ...
  CREATE TABLE movimentos (empresa_id INTEGER, competencia TEXT, tipo TEXT, sentido TEXT, cfop TEXT, nbs TEXT, lc116 TEXT, modelo_documento_fiscal TEXT, valor REAL, iss REAL);
...
assert.strictEqual(julho.receita.valor, 1000, 'Documento fiscal e outras receitas confirmadas compõem a receita analisada');
