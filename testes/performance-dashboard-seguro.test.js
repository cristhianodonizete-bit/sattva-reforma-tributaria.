...
assert.match(app, /Promise\.all\(\[carregarParametros\(\), carregarEmpresas\(\), atualizarNotificacoesReforma\(\)\]\)/, 'leituras iniciais independentes devem ocorrer em paralelo');
